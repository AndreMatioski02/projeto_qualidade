...
<script type="text/javascript" language="javascript">
    ...
    $('#cadUsuario').on('submit', function(event){
        event.preventDefault(); // Evitando qualquer ação padrão do navegador
        var form_data = $(this).serialize(); // Montando um Array com cada informação que tem na tela
        $.ajax({
            url:"registraUsuario.php",
            method:"POST",
            data:form_data,
            success:function(data){  
                window.location.href = "./home.php"; // window.location.href redireciona a página após o sucesso
            }
        })
    });
</script>
